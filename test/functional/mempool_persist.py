...
By default, bitzenyd will dump mempool on shutdown and
...
class MempoolPersistTest(BitzenyTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give bitzenyd a second to reload the mempool
        ...
        self.log.debug("Prevent bitzenyd from writing mempool.dat to disk. Verify that `savemempool` fails")
