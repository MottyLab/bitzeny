...
"""Verify that starting bitzeny with -h works as expected."""
import subprocess

from test_framework.test_framework import BitzenyTestFramework
from test_framework.util import assert_equal

class HelpTest(BitzenyTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitzeny with -h for help text")
        ...
        self.log.info("Start bitzeny with -version for version information")
