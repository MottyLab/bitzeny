...
# TestNode: A peer we use to send messages to bitzenyd, and store responses.
...
class CompactBlocksTest(BitzenyTestFramework):
    ...
    # This test actually causes bitzenyd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitzenyd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitzenyd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitzenyd will not send blocktxn responses for blocks whose height is
