...
#ifndef BITZENY_QT_BITZENYUNITS_H
#define BITZENY_QT_BITZENYUNITS_H
...
/** Bitzeny unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitzenyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitzenyUnits(QObject *parent);

    /** Bitzeny units.
      @note Source: https://en.bitzeny.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef BitzenyUnits::Unit BitzenyUnit;

#endif // BITZENY_QT_BITZENYUNITS_H
