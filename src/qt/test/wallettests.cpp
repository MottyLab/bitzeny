...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitzenyAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitzeny-qt -platform xcb      # Linux
//     src/qt/test/test_bitzeny-qt -platform windows  # Windows
//     src/qt/test/test_bitzeny-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BitzenyUnits::formatWithUnit(unit, balance, false, BitzenyUnits::separatorAlways);
    ...
    // Amount input
    BitzenyAmountField* amountInput = receiveCoinsDialog.findChild<BitzenyAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitzeny:")) != -1);
