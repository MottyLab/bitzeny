...
#ifndef BITZENY_TEST_SCRIPTNUM10_H
#define BITZENY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitzeny Core 0.10.0, for cross-comparison.
 */
public:
