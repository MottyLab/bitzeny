...
#ifndef BITZENY_WALLET_WALLET_H
#define BITZENY_WALLET_WALLET_H
...
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 500000;
...
public:
     ...
     * on this bitzeny node, and set to 0 for transactions that were created
