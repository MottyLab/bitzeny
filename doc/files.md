...
* bitzeny.conf: contains configuration settings for bitzenyd or bitzeny-qt
* bitzenyd.pid: stores the process id of bitzenyd while running
...
* debug.log: contains debug information and general logging generated by bitzenyd or bitzeny-qt
