...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitzeny.org server
...
- Announce the release:
  ...
  - Bitzeny Core announcements list https://bitcoincore.org/en/list/announcements/join/
