...
This document provides guidelines for internationalization of the Bitzeny Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitzeny_en.ts` remains unchanged.
