Bitzeny Core version 0.10.4 is now available from:

  <https://bitzeny.org/bin/bitzeny-core-0.10.4/>
...
- #6953 `43c2789` Split bitzeny-tx into its own package
- #6953 `dfe0d4d` Include bitzeny-tx binary on Debian/Ubuntu
