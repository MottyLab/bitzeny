Bitzeny Core version *0.15.2* is now available from:

  <https://bitzenycore.org/bin/bitzeny-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitzeny-tx (TheBlueMatt)
