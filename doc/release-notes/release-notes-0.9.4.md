Bitzeny Core version 0.9.4 is now available from:

  https://bitzeny.org/bin/0.9.4/
...
this update is incompatible with the Bitzeny system and could lead to consensus
forks.

Bitzeny Core released binaries from https://bitzeny.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitzeny/+archive/ubuntu/bitzeny
- A third-party or self-compiled Bitzeny Core

upgrade to Bitzeny Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
