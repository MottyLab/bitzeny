Bitzeny Core version 0.13.2 is now available from:

  <https://bitzeny.org/bin/bitzeny-core-0.13.2/>
...
- #8908 `4a974b2` Update bitzeny-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitzeny-tx to create v2 transactions (btcdrak)
