Bitzeny Core version 0.10.3 is now available from:

  <https://bitzeny.org/bin/bitzeny-core-0.10.3/>
...
(see https://github.com/bitzeny/bitzeny/pull/6793, as well as the 0.11.0
