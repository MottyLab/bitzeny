Bitzeny version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitzeny/files/Bitzeny/bitzeny-0.5.4/
...
http://gitorious.org/bitzeny/bitzenyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitzeny-Qt notifications under Growl 1.3.
Increase required age of Bitzeny-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitzeny properly when installing Bitzeny-Qt over it. (Windows)
