Bitzeny-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitzeny/files/Bitzeny/bitzeny-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitzeny
...
New/changed settings (command-line or bitzeny.conf file)
--------------------------------------------------------
