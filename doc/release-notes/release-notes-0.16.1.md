Bitzeny Core version 0.16.1 is now available from:

  <https://bitzenycore.org/bin/bitzeny-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitzenyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitzenyd processes are cleaned up when tests end (sdaftuar)
